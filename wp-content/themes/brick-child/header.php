...
<head>
	...
	<meta name="facebook-domain-verification" content="gdvwtnbcjstgz8fk18r5c64s5yvopn" />
	...
	<script>
		...
		fbq('init', '230364475650134');
		fbq('track', 'PageView');
	</script>
	<noscript><img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=230364475650134&ev=PageView&noscript=1" /></noscript>
	...
	<?php if ($enable_side_area == "yes" && $enable_popup_menu == 'no' && !$enable_vertical_menu) { ?>
		<section class="side_menu right">
			...
			<div class="close_side_menu_holder">
				<div class="close_side_menu_holder_inner"><a href="#" target="_self" class="close_side_menu"><span aria-hidden="true" class="icon_close"></span></a></div>
			</div>
	...
	<div class="wrapper">
		<div class="wrapper_inner">
						...
						<?php if (brick_qode_options()->getOptionValue('show_logo') != "no") { ?>
							<div class="vertical_logo_wrapper">
								...
								if (brick_qode_options()->getOptionValue('logo_image') != "") {
									$logo_image = brick_qode_options()->getOptionValue('logo_image');
								} else {
									$logo_image =  get_template_directory_uri() . '/img/logo.png';
								};
								if (brick_qode_options()->getOptionValue('logo_image_light') != "") {
									$logo_image_light = brick_qode_options()->getOptionValue('logo_image_light');
								} else {
									$logo_image_light =  get_template_directory_uri() . '/img/logo.png';
								};
								if (brick_qode_options()->getOptionValue('logo_image_dark') != "") {
									$logo_image_dark = brick_qode_options()->getOptionValue('logo_image_dark');
								} else {
					...
					<header class="<?php brick_qode_header_classes(); ?>">
						<div class="header_inner clearfix">
													...
													<div class="form_holder_outer">
														<div class="form_holder">
															...
															<div class="qode_search_close">
																<a href="#">
																	<?php if (brick_qode_options()->getOptionValue('header_icon_pack')) {
																		brick_qode_icon_collections()->getSearchClose(brick_qode_options()->getOptionValue('header_icon_pack'));
																	} ?>
							...
							<div class="header_top_bottom_holder">
								...
								<?php } ?>
								<div class="header_bottom <?php echo esc_attr($header_bottom_class); ?> clearfix <?php if ($menu_item_icon_position == "top") {
																														echo 'with_large_icons ';
																													}
																													if ($menu_position == "left" && $header_bottom_appearance != "fixed_hiding" && $header_bottom_appearance != "stick menu_bottom" && $header_bottom_appearance != "stick_with_left_right_menu") {
																														echo 'left_menu_position';
																													} ?>" <?php brick_qode_inline_style($header_color_per_page); ?>>
									<?php if ($header_in_grid) { ?>
										<div class="container">
												...
												<div class="header_inner_left">
													...
													<?php if (!(brick_qode_options()->getOptionValue('show_logo') == "no")) { ?>
														<div class="logo_wrapper" <?php brick_qode_inline_style($logo_wrapper_style); ?>>
															...
															if (brick_qode_options()->getOptionValue('logo_image_sticky') != "") {
																$logo_image_sticky = brick_qode_options()->getOptionValue('logo_image_sticky');
															} else {
																$logo_image_sticky =  get_template_directory_uri() . '/img/logo_black.png';
															};
															if (brick_qode_options()->getOptionValue('logo_image_popup') != "") {
																$logo_image_popup = brick_qode_options()->getOptionValue('logo_image_popup');
															} else {
																$logo_image_popup =  get_template_directory_uri() . '/img/logo_white.png';
															};
															if (brick_qode_options()->getOptionValue('logo_image_fixed_hidden') != "") {
																$logo_image_fixed_hidden = brick_qode_options()->getOptionValue('logo_image_fixed_hidden');
															} else {
														...
														<div class="side_menu_button_wrapper right">
															...
															<div class="side_menu_button">
																...
																?>
																	...
																	<?php if (brick_qode_options()->getOptionValue('search_icon_pack')) {
																		brick_qode_icon_collections()->getSearchIcon(brick_qode_options()->getOptionValue('search_icon_pack'));
																	} ?>
													...
													<?php if ($header_bottom_appearance == "fixed_hiding") { ?> <div class="holeder_for_hidden_menu"> <?php } //only for fixed with hiding menu 
														...
														<?php if (!$centered_logo) { ?>
															<div class="header_inner_right">
																<div class="side_menu_button_wrapper right">
																	<?php echo do_shortcode('[popup_anything id="51974"]'); ?>
														...
														<?php if ($centered_logo == true && $enable_border_top_bottom_menu == true) { ?> <div class="main_menu_and_widget_holder"> <?php } //only for logo is centered 
															...
															<nav class="main_menu drop_down  <?php echo esc_attr($menu_dropdown_appearance_class);
																								if ($menu_position == "" && $header_bottom_appearance != "stick menu_bottom") {
																									echo ' right';
																								} ?>">
																<?php
															...
															</div> <?php } //only for logo is centered 
																	?>
														<?php if ($header_bottom_appearance == "fixed_hiding") { ?>
														</div> <?php } //only for fixed with hiding menu 
																?>
			...
			<?php } else { ?>
				...
				<header class="page_header <?php if ($display_header_top == "yes") {
												echo 'has_top';
											}
											if ($header_top_area_scroll == "yes") {
												echo ' scroll_top';
																																										...
																																										echo " centered_logo";
																																									} ?> <?php echo esc_attr($header_bottom_appearance); ?>  <?php echo esc_attr($header_style); ?> <?php if (is_active_sidebar('header_fixed_right')) {
																																																																															echo 'has_header_fixed_right';
																																																																														} ?>">
					<div class="header_inner clearfix">
						<div class="header_bottom <?php echo esc_attr($header_bottom_class); ?> clearfix" <?php brick_qode_inline_style($header_color_per_page); ?>>
							<?php if ($header_in_grid) { ?>
