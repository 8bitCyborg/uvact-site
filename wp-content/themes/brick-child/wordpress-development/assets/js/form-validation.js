...
(function( $ ) {
    ...
    jQuery("#contact-form").submit(function(event) {
        ...
        if( ($(".chkSkillsets").length > 0 ) && ( $(".chkSkillsets:checked").length < 1) ) {
            $thisForm.find('.groupSkillset').addClass('error').append('<span class="error-message text-red">Select atleast one skill.</span>');
            if (popError == false)
                popError = true;
        }

        if( ($('input[name="certifications_docs"]').val()=="") && ($('input[name="job_description"]').val()=="") ) {
    ...
    jQuery("#rate_card_form, #employee-referral-form, #enquiry-form, #network-form, #callback-form, #popup-validation, .poc-form, #paid-form, #quotes-form, #covid-survey-form, #guide-to-building-offshore-teams, #offshore-regions-comparison-guide").submit(function(event) {
        ...
        jQuery(this).find('input, textarea').each(function(i, field) {
            ...
            //     }
            // }
            else if(field.name === 'what_is_your_preferred_web_development_technology') {
        ...
        if( (jQuery("input[name^='which_service_are_you_interested_in_one']").length > 0) ) {
        ...
        if( (jQuery("input[name^='what_are_your_preferred_paid_marketing_channels']").length > 0) ) {
        ...
        if((jQuery("select[name='what_is_your_preferred_web_development_technology']").val() == "Others") && jQuery("input[name='what_is_your_preferred_web_development_technology_other']").val() == "" ) {
        ...
        if((jQuery("select[name='what_is_your_preferred_esp']").val() == "Others") && jQuery("input[name='what_is_your_preferred_esp_other']").val() == "" ) {
        ...
        if( (jQuery("input[name^='which_digital_marketing_services_you_need']").length > 0) ) {
            ...
            } else if( (jQuery("input[id='which_digital_marketing_services_you_need_other']:checked").length > 0) && (jQuery("input[name='which_digital_marketing_services_you_need_other']").val() == "")) {
                if(!jQuery("input[name='which_digital_marketing_services_you_need_other']").parent().parent().hasClass('error')){
                    jQuery("input[name='which_digital_marketing_services_you_need_other']").parent().addClass('error').append('<span class="error-message">Please specify the other option.</span>');
                    if (popError == false)
                        popError = true;
                }
            } 
                    ...
                    success: function(data) {
                        ...
                        if (data.result == 'fail') {
                            ...
                            if(form_id == "covid-survey-form"){ 
                                window.open("https://www.uvact.com/wp-content/themes/uvact/assets/pdf/The-Impact-of-COVID-19-on-Digital-Agencies-A-Survey-Report.pdf", 'Download');
                            }
                            else if(form_id == "guide-to-building-offshore-teams"){ 
                                window.open("https://www.uvact.com/offshore/A-guide-to-building-offshore-teams-in-2021.pdf", 'Download');
                            }
                            else if(form_id == "offshore-regions-comparison-guide"){ 
                                window.open("https://www.uvact.com/offshore/Offshore-regions-comparison-guide.pdf", 'Download');
                            }
                ...
                success: function(data) {
                    ...
                    if (data.result == 'fail') {
                        ...
                        if ($("input[name='download_ratecard']").attr('checked'))
                        {
                            ...
                            if(url == "https://www.uvact.com/design-services/")
                            {
                                window.open("https://www.uvact.com/wp-content/uploads/2020/04/Uplers-Design-US.pdf", 'Download');
                            }else{
                                window.open("https://www.uvact.com/wp-content/uploads/2020/04/Uplers-HubSpot-US.pdf", 'Download');
                            }
