...
$default_attrs = array_merge(brick_qode_icon_collections()->getShortcodeParams(), $default_attrs);
...
if(isset($icon_pack) && $icon_pack !== '') {
	...
	$collection_obj = brick_qode_icon_collections()->getIconCollection($icon_pack);
...
$output .= ($content=='' || $content==' ') ? esc_html__("Empty section. Edit page to add content here.", "brick") : "\n\t\t\t\t" . wpb_js_remove_wpautop($content);
