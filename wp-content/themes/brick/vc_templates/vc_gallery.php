...
if(version_compare(brick_qode_get_vc_version(), '4.7.4') >= 0) {
    ...
    foreach ( $images as $i => $image ) {
        ...
        switch ( $onclick ) {
            case 'img_link_large':
                $link_start = '<a href="' . esc_url($large_img_src) . '" target="' . $custom_links_target . '">' . $hover_image;
                $link_end = '</a>';
                break;
    ...
    if($frame == 'use_frame'){
        ...
        $output .="<div class='gallery_frame'>";
            if($choose_frame == "frame2"){
                $output .= "<img src='" . get_template_directory_uri() ."/img/slider_frame-2.png' alt='" . esc_attr__( 'Slider frame image', 'brick' ) . "' />";
            }elseif ($choose_frame == "frame3"){
                $output .= "<img src='" . get_template_directory_uri() ."/img/slider_frame-3.png' alt='" . esc_attr__( 'Slider frame image', 'brick' ) . "' />";
            }elseif ($choose_frame == "frame4"){
                $output .= "<img src='" . get_template_directory_uri() ."/img/slider_frame-4.png' alt='" . esc_attr__( 'Slider frame image', 'brick' ) . "' />";
            }else {
                $output .= "<img src='" . get_template_directory_uri() ."/img/slider_frame.png' alt='" . esc_attr__( 'Slider frame image', 'brick' ) . "' />";
            }
        $output .="</div>";
    }
    $output .= '</div>';
    ...
    foreach ( $images as $attach_id ) {
        ...
        if ( $onclick == 'link_image' ) {
            $link_start = '<a class="lightbox_single_portfolio" href="'.esc_url($p_img_large[0]).'"'.$pretty_rel_random.'>' . $hover_image;
            $link_end = '</a>';
        }
