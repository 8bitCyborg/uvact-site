...
$output .= "</div>";
if ('vc_tour' == $this->shortcode) {
    $output .= "\n\t\t\t" . '<div class="wpb_tour_next_prev_nav clearfix"> <span class="wpb_prev_slide"><a href="#prev" title="' . esc_attr__('Previous slide', 'brick') . '">' . esc_html__('Previous slide', 'brick') . '</a></span> <span class="wpb_next_slide"><a href="#next" title="' . esc_attr__('Next slide', 'brick') . '">' . esc_html__('Next slide', 'brick') . '</a></span></div>';
}
