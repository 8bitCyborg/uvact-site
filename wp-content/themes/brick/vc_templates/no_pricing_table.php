...
if($show_button == "yes"){
	if($pricing_button_type == "standard_button"){
		if(isset($button_text) && $button_text !== '') {
			$html .="<li class='price_button $button_class' ".brick_qode_get_inline_style($button_holder_style)." >";
			if($type=="title_on_top"){
				$html .= "<div class='title_on_top_button_wrapper $disable_button_border_top_class'>";
				$html .= "<a ".brick_qode_get_inline_style($button_style)." href='".esc_url($link)."' target='$target'>".$button_text."";
				if($button_arrow == "yes"){
		...
		$html .="<a class='button_on_bottom' ".brick_qode_get_inline_style($button_on_bottom_styles)." href='".esc_url($link)."' target='$target'></a>";
		$html .="</li>";//close li.price_button
	}
}
