<?php
if(version_compare(brick_qode_get_vc_version(), '4.6.2') >= 0) {
...
?>
    <div class="<?php echo esc_attr(trim($css_class)); ?>" <?php echo brick_qode_get_module_part( $inline_css );
...
<?php echo brick_qode_get_module_part( $this->endBlockComment('empty_space') )."\n";