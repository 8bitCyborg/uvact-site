...
';
    ...
    if ($img_link_target !== "open_prettyphoto"){
        ...
        $image_string = '<div class="prettyphoto_container"><a' . $a_class . ' href="' . esc_url($link_to) . '"  ' .$rel. '><div class="vc_single_image-wrapper ' . $style . ' ' . $border_color . '"><span><i class="fa fa-search"></i></span>' . $img_output . '</div></a></div>';
    }
