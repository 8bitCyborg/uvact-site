...
extract( brick_qode_get_footer_options() );
...
<?php if( brick_qode_options()->getOptionValue( 'paspartu' ) == 'yes'){?>
...
<?php if ( $display_footer_top || $display_footer_text ) { ?>
	<footer <?php brick_qode_class_attribute( $footer_classes ); ?>>
		<div class="footer_inner clearfix">
			<?php if($display_footer_top) {
				if($footer_top_border_color != ''){ ?>
					...
					<?php } ?>
					<div class="footer_top_border_holder <?php echo esc_attr($footer_top_border_in_grid); ?>" <?php brick_qode_inline_style($footer_top_border_color); ?>></div>
					<?php if($footer_top_border_in_grid != '') { ?>
						</div>
					<?php } ?>
				<?php } ?>
			...
			<?php if($display_footer_text): ?>
				<?php if($footer_bottom_border_color != ''){ ?>
					<?php if($footer_bottom_border_in_grid != '') { ?>
						<div class="footer_ingrid_border_holder_outer">
					<?php } ?>
					<div class="footer_bottom_border_holder <?php echo esc_attr($footer_bottom_border_in_grid); ?>" <?php brick_qode_inline_style($footer_bottom_border_color); ?>></div>
					<?php if($footer_bottom_border_in_grid != '') { ?>
						</div>
					<?php } ?>
				<?php } ?>
				...
				<?php if($footer_bottom_border_bottom_color != ''){ ?>
					<div class="footer_bottom_border_bottom_holder <?php echo esc_attr($footer_top_border_in_grid); ?>" <?php brick_qode_inline_style($footer_bottom_border_bottom_color); ?>></div>
				<?php } ?>
			<?php endif; ?>
		</div>
	</footer>
