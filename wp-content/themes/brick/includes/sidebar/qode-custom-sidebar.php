...
if( ! class_exists( 'BrickQodeSidebar' ) ){
	class BrickQodeSidebar{
		var $sidebars  = array();
		var $stored    = "";
		...
		function __construct(){
			...
			$this->title = esc_html__('Custom Widget Area','brick');
		...
		function load_assets(){
			...
			wp_enqueue_script('brick-sidebar' , BRICK_ROOT . '/framework/admin/assets/js/qodef-sidebar.js');
			wp_enqueue_style( 'brick-sidebar' , BRICK_ROOT . '/framework/admin/assets/css/qodef-sidebar.css');
		}
		...
		function template_add_widget_field(){
			...
			echo "\n    <span class='input_wrap'><input type='text' value='' placeholder = '".esc_attr__('Enter Name of the new Widget Area', 'brick')."' name='qode-add-widget' /></span>";
			echo "\n    <input class='button' type='submit' value='".esc_attr__('Add Widget Area', 'brick')."' />";
			echo "\n    ".$nonce;
			echo "\n  </form>";
			echo "\n</script>\n";
		}
		...
		function register_custom_sidebars() {
			...
			$args = apply_filters( 'brick_qode_filter_custom_widget_args', $args );
