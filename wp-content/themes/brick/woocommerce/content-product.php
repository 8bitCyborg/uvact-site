...
if ( brick_qode_options()->getOptionValue( 'woo_products_list_type' ) ) {
	$products_list_type = brick_qode_options()->getOptionValue( 'woo_products_list_type' );
}
...
if ( brick_qode_options()->getOptionValue( 'woo_products_enable_lighbox_icon' ) ) {
	$woo_products_enable_lighbox_icon_yes_no = brick_qode_options()->getOptionValue( 'woo_products_enable_lighbox_icon' );
}

$hide_separator = "no";
if ( brick_qode_options()->getOptionValue( 'woo_products_title_separator_hide_title_separator' ) ) {
	$hide_separator = brick_qode_options()->getOptionValue( 'woo_products_title_separator_hide_title_separator' );
}
?>
	...
	<li <?php wc_product_class( '', $product ); ?>>
		<?php do_action( 'woocommerce_before_shop_loop_item' ); ?>
			<div class="top-product-section">
				...
				<?php do_action('brick_qode_action_woocommerce_after_product_image'); ?>
			</div>
