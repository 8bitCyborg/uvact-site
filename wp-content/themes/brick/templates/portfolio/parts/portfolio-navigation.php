...
if ( brick_qode_options()->getOptionValue( 'portfolio_hide_pagination' ) == "yes"){
    $enable_navigation = false;
}

$navigation_through_category = false;
if ( brick_qode_options()->getOptionValue( 'portfolio_navigation_through_same_category' ) == "yes")
...
if ( brick_qode_options()->getOptionValue( 'portfolio_single_navigation_arrows_type' ) != '') {
    $icon_navigation_class = brick_qode_options()->getOptionValue( 'portfolio_single_navigation_arrows_type' );
}
...
if (brick_qode_options()->getOptionValue( 'portfolio_back_to_button_choice' ) == 'icon'){
    if ( brick_qode_options()->getOptionValue( 'portfolio_back_to_button_icon' ) != '') {
        $back_to_button = brick_qode_options()->getOptionValue( 'portfolio_back_to_button_icon' );
        $back_to_button_code = '<span class="' . $back_to_button . '"></span>';
    }
}
elseif (brick_qode_options()->getOptionValue( 'portfolio_back_to_button_choice' ) == 'custom_icon') {
    if ( brick_qode_options()->getOptionValue( 'portfolio_back_to_button_custom_icon' ) != '') {
