				...
				<div class="post_content_column text-wrapper">
					<div class="post_text">
						<div class="post_text_inner">
							...
							<?php
								brick_qode_excerpt();
								brick_qode_read_more_button('blog_split_column_read_more_button');
							?>
							<?php if(brick_qode_options()->getOptionValue( 'blog_split_column_show_share' ) == "yes" && $blog_social_share_type == "list") {
