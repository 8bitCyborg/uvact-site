...
if ( has_tag() ) { ?>
	<div class="single_tags clearfix">
		<div class="tags_text">
			<<?php echo esc_attr( $title_tag ); ?> class="single_tags_heading"><?php esc_html_e( 'Tags:', 'brick' ); ?></<?php echo esc_attr( $title_tag ); ?>>
		<?php the_tags( '', '', '' ); ?>
	</div>
	</div>
<?php } ?>
...
if ( brick_qode_options()->getOptionValue( 'blog_author_info' ) == "yes" && get_the_author_meta( 'description' ) != "" ) { ?>
	<div class="author_description">
		<div class="author_description_inner">
			<div class="image">
				<?php echo brick_qode_get_module_part( get_avatar( get_the_author_meta( 'ID' ), 102 ) ); ?>
			</div>
			...
			<?php if ( brick_qode_options()->getOptionValue( 'enable_author_info_email' ) == "yes" && is_email( get_the_author_meta( 'email' ) ) ) { ?>
