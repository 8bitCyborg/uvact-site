...
if (brick_qode_options()->getOptionValue( 'blog_vertical_loop_type_show_categories' )){
	$blog_show_categories = brick_qode_options()->getOptionValue( 'blog_vertical_loop_type_show_categories' );
}

$blog_show_comments = "yes";
if (brick_qode_options()->getOptionValue( 'blog_vertical_loop_type_show_comments' )){
	$blog_show_comments = brick_qode_options()->getOptionValue( 'blog_vertical_loop_type_show_comments' );
}
$blog_show_author = "yes";
if (brick_qode_options()->getOptionValue( 'blog_vertical_loop_type_show_author' )){
	$blog_show_author = brick_qode_options()->getOptionValue( 'blog_vertical_loop_type_show_author' );
}
$blog_show_like = "yes";
if (brick_qode_options()->getOptionValue( 'blog_vertical_loop_type_show_like' )) {
	$blog_show_like = brick_qode_options()->getOptionValue( 'blog_vertical_loop_type_show_like' );
}
$blog_show_ql_icon_mark = "yes";
$blog_title_holder_icon_class = "";
if (brick_qode_options()->getOptionValue( 'blog_vertical_loop_type_show_ql_mark' )) {
	$blog_show_ql_icon_mark = brick_qode_options()->getOptionValue( 'blog_vertical_loop_type_show_ql_mark' );
}
...
$blog_show_date = "yes";
if (brick_qode_options()->getOptionValue( 'blog_vertical_loop_type_show_date' )) {
	$blog_show_date = brick_qode_options()->getOptionValue( 'blog_vertical_loop_type_show_date' );
}
$blog_show_social_share = "no";
$blog_social_share_type = "dropdown";
if(brick_qode_options()->getOptionValue( 'blog_vertical_loop_type_select_share_option' )){
	$blog_social_share_type = brick_qode_options()->getOptionValue( 'blog_vertical_loop_type_select_share_option' );
}
if (brick_qode_options()->getOptionValue( 'enable_social_share' ) =="yes"){
	if (brick_qode_options()->getOptionValue( 'post_types_names_post' ) =="post"){
		if (brick_qode_options()->getOptionValue( 'blog_vertical_loop_type_show_share' )&& $blog_social_share_type == "dropdown") {
			$blog_show_social_share = brick_qode_options()->getOptionValue( 'blog_vertical_loop_type_show_share' );
		}
	}
}
...
$number_of_pages = intval(brick_qode_return_global_wp_query()->max_num_pages);
if($paged - 2 == 0){
							...
							<div class="post_text_inner">
								<?php if(get_post_meta($id, "qode_page_subtitle", true) != ""){ ?>
									<div class="post_subtitle">
										<span><?php echo esc_attr(get_post_meta($id, "qode_page_subtitle", true))?></span>
									</div>
								<?php } ?>
								<h2>
								...
								<?php the_content(); ?>
								<?php if(brick_qode_options()->getOptionValue( 'blog_vertical_loop_type_show_share' ) == "yes" && $blog_social_share_type == "list") {
									echo do_shortcode('[no_social_share_list]'); // XSS OK
								}; ?>
								<a class="qbutton  small white loop_more" href="<?php the_permalink(); ?>"><?php esc_html_e('Post a comment', 'brick'); ?></a>
							</div>
						</div>
					</div>
				</div>
