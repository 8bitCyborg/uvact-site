...
function qode_icon_collections(){
	return brick_qode_icon_collections();
}

function init_qode_icon_collections() {
	global $qodeIconCollections;
	$qodeIconCollections = brick_qode_icon_collections();
}

add_action( 'after_setup_theme', 'init_qode_icon_collections' );
...
function qode_get_attachment_meta_from_url(){
	return null;
}

function qodef_get_attachment_thumb_url(){
	return null;
}

function qode_horizontal_slider_icon_classes(){
	return null;
}