...
class QodeIconsIonIcons implements iIconCollection {
	...
	function __construct($title = "", $param = "") {
		...
		$this->styleUrl = BRICK_ROOT . "/css/ion-icons/css/ionicons.min.css";
	}
	...
	public function render($icon, $params = array()) {
		...
		$html .= '<i class="qode_icon_ion_icon ' . $icon . ' ' . $iconClass . '" ' . $iconAttributesString . '></i>';
