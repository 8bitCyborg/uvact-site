...
class BrickQodeSkin extends BrickQodeSkinAbstract {
    /**
     * Skin constructor. Hooks to brick_qode_action_admin_scripts_init and brick_qode_action_enqueue_admin_styles
     */
	public function __construct() {
		$this->skinName = 'select';

        //hook to admin register scripts
        add_action('brick_qode_action_admin_scripts_init', array($this, 'registerStyles'));
        add_action('brick_qode_action_admin_scripts_init', array($this, 'registerScripts'));

        //hook to admin enqueue scripts
        add_action('brick_qode_action_enqueue_admin_styles', array($this, 'enqueueStyles'));
        add_action('brick_qode_action_enqueue_admin_scripts', array($this, 'enqueueScripts'));

        add_action('brick_qode_action_enqueue_meta_box_styles', array($this, 'enqueueStyles'));
        add_action('brick_qode_action_enqueue_meta_box_scripts', array($this, 'enqueueScripts'));
    ...
    public function registerScripts() {
        ...
        foreach ($this->scripts as $scriptHandle => $scriptPath) {
            brick_qode_register_skin_script($scriptHandle, $scriptPath);
        }
    }
    ...
    public function registerStyles() {
        ...
        foreach ($this->styles as $styleHandle => $stylePath) {
            brick_qode_register_skin_style($styleHandle, $stylePath);
        }
     ...
     *
     * @see BrickQodeSkin::getHeader()
     * @see BrickQodeSkin::getPageNav()
     * @see BrickQodeSkin::getPageContent()
     */
	public function renderOptions() {
        global $brick_qode_framework;
        $tab    = brick_qode_get_admin_tab();
        $active_page = $brick_qode_framework->qodeOptions->getAdminPageFromSlug($tab);
     ...
     *
     * @see BrickQodeSkinAbstract::loadTemplatePart()
     */
     ...
     * @param BrickQodeAdminPage $page current page to load
     *
     * @see BrickQodeSkinAbstract::loadTemplatePart()
     */
     ...
     * @see BrickQodeSkin::getHeader()
     * * @see BrickQodeSkin::getPageNav()
     * * @see BrickQodeSkin::getImportContent()
     */
