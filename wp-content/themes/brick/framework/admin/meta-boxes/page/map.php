...
$qode_enable_content_top_margin = new QodeMetaField(
	"yesnosimple",
	"qode_enable_content_top_margin",
	"no",
	esc_html__( "Always put content below header", 'brick' ),
	esc_html__( "Enabling this option always will put content below header ", 'brick' )
);
$row1->addChild(
	"qode_enable_content_top_margin",
	$qode_enable_content_top_margin
...
$qode_page_vertical_area_transparency = new QodeMetaField(
	...
	esc_html__( "Enabling this option will make Side Menu background transparent ", 'brick' ),
	array(
		"no" => esc_html__( "No", 'brick' ),
		"yes" => esc_html__( "Yes", 'brick' )
	)
...
$qode_page_vertical_area_background = new QodeMetaField(
	...
	esc_html__( "Choose a color for Side Menu background", 'brick' )
);
$qodeLeftMenuArea->addChild(
	"qode_page_vertical_area_background",
	$qode_page_vertical_area_background
...
$qode_show_page_title_image = new QodeMetaField(
	...
	array(
		...
		"dependence_show_on_yes" => "#qodef_qode_title-height"
	)
);
$qode_page_title_area_container->addChild(
	"qode_show-page-title-image",
...
$qode_choose_blog_category = new QodeMetaField(
	"selectblank",
	"qode_choose-blog-category",
	"",
	esc_html__( "Blog Category", 'brick' ),
	esc_html__( "Choose category of posts to display (leave empty to display all categories)", 'brick' ),
	$qode_blog_categories
);
$qodeBlog->addChild(
	"qode_choose-blog-category",
	$qode_choose_blog_category
);

$qode_show_posts_per_page = new QodeMetaField(
	"text",
	"qode_show-posts-per-page",
	"",
	esc_html__( "Number of Posts", 'brick' ),
	esc_html__( "Enter the number of posts to display", 'brick' ),
	array(),
	array( "col_width" => 3 )
);
$qodeBlog->addChild(
	"qode_show-posts-per-page",
	$qode_show_posts_per_page
);

$qode_enable_page_comments = new QodeMetaField(
	"yesno",
	"qode_enable-page-comments",
	"no",
	esc_html__( "Show Comments", 'brick' ),
	esc_html__( "Enabling this option will show comments on your page ", 'brick' )
);
$qodeBlog->addChild(
	"qode_enable-page-comments",
	$qode_enable_page_comments
);
...
$qodeFullScreenTemplate = new BrickQodeMetaBox(
	"page",
	esc_html__( "Full Screen Template", 'brick' )
);
$brick_qode_framework->qodeMetaBoxes->addMetaBox(
	"page_full_screen_template",
	$qodeFullScreenTemplate
);

$qode_full_screen_sections_on_small_screens = new QodeMetaField(
	"selectblank",
	"qode_full_screen_sections_on_small_screens",
	"",
...
$qodeFullScreenTemplate->addChild(
	"qode_full_screen_sections_on_small_screens",
	$qode_full_screen_sections_on_small_screens
);
