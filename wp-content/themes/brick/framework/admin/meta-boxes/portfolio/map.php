...
$qodePortfolioImages = new BrickQodeMetaBox(
	"portfolio_page",
	esc_html__( "Portfolio Images (multiple upload)", 'brick' )
);
...
$qode_portfolio_image_gallery = new QodeMultipleImages(
	"qode_portfolio-image-gallery",
	esc_html__( "Portfolio Images", 'brick' ),
	esc_html__( "Choose your portfolio images", 'brick' )
);
...
$qodePortfolioImagesVideos = new BrickQodeMetaBox("portfolio_page", "Select Portfolio Images/Videos (single upload)");
$brick_qode_framework->qodeMetaBoxes->addMetaBox("portfolio_images_videos",$qodePortfolioImagesVideos);

	$qode_portfolio_images_videos = new QodeImagesVideos("Portfolio Images/Videos",esc_html__( "ThisIsDescription", 'brick' ));
	$qodePortfolioImagesVideos->addChild("qode_portfolio_images_videos",$qode_portfolio_images_videos);
*/
//Portfolio Images/Videos 2

$qodePortfolioImagesVideos2 = new BrickQodeMetaBox(
	"portfolio_page",
	esc_html__( "Portfolio Images/Videos (single upload)", 'brick' )
);
$brick_qode_framework->qodeMetaBoxes->addMetaBox(
...
$qode_portfolio_images_videos2 = new QodeImagesVideosFramework(
	esc_html__( "Portfolio Images/Videos 2", 'brick' ),
...
$qodeAdditionalSidebarItems = new BrickQodeMetaBox(
	"portfolio_page",
	esc_html__( "Additional Portfolio Sidebar Items", 'brick' )
);
$brick_qode_framework->qodeMetaBoxes->addMetaBox(
...
$qode_portfolio_properties = new QodeOptionsFramework(
	esc_html__( "Portfolio Properties", 'brick' ),
	esc_html__( "ThisIsDescription", 'brick' )
);
...
$qode_choose_portfolio_single_view = new QodeMetaField(
	"selectblank",
...
$qode_choose_number_of_portfolio_columns_container = new QodeContainer(
...
$qode_choose_number_of_portfolio_columns = new QodeMetaField(
	"selectblank",
	"qode_choose-number-of-portfolio-columns",
	"",
	esc_html__( "Number of Columns", 'brick' ),
	esc_html__( 'Choose the number of columns for Portfolio Gallery type', 'brick' ),
	array(
...
$qode_choose_portfolio_image_size = new QodeMetaField(
	"select",
	"qode_choose-portfolio-image-size",
	"full",
	esc_html__( "Image Proportions", 'brick' ),
	esc_html__( 'Choose image proportions for Portfolio Gallery type', 'brick' ),
	array(
		"full" => esc_html__( "Original Size", 'brick' ),
		"portfolio-square" => esc_html__( "Square", 'brick' ),
		"portfolio-landscape" => esc_html__( "Landscape", 'brick' ),
		"portfolio-portrait" => esc_html__( "Portrait", 'brick' )
	)
);
...
$qode_choose_portfolio_list_page = new QodeMetaField(
	"selectblank",
	"qode_choose-portfolio-list-page",
	"",
	esc_html__( "Back To Link", 'brick' ),
	esc_html__( 'Choose "Back To" page to link from portfolio Single Project page', 'brick' ),
	$qode_pages
);
$qodeGeneral->addChild(
	"qode_choose-portfolio-list-page",
...
$qode_portfolio_external_link = new QodeMetaField(
	"text",
	"qode_portfolio-external-link",
	"",
	esc_html__( "Portfolio External Link", 'brick' ),
	esc_html__( "Enter URL to link from Portfolio List page", 'brick' )
);
$qodeGeneral->addChild(
	"qode_portfolio-external-link",
...
$qode_portfolio_lightbox_link = new QodeMetaField(
	"text",
	"qode_portfolio-lightbox-link",
	"",
	esc_html__( "Portfolio Custom Lighbox Content", 'brick' ),
	esc_html__( "Enter URL to link custom image/video content inside lightbox", 'brick' )
);
$qodeGeneral->addChild(
	"qode_portfolio-lightbox-link",
...
$qode_portfolio_type_masonry_style = new QodeMetaField(
	"select",
	"qode_portfolio_type_masonry_style",
	"",
	esc_html__( "Dimensions for Masonry", 'brick' ),
	esc_html__( 'Choose image layout when it appears in Masonry type portfolio lists', 'brick' ),
	array(
		"default" => esc_html__( "Default", 'brick' ),
		"large_width" => esc_html__( "Large width", 'brick' ),
		"large_height" => esc_html__( "Large height", 'brick' ),
		"large_width_height" => esc_html__( "Large width/height", 'brick' )
	)
);
$qodeGeneral->addChild(
	"qode_portfolio_type_masonry_style",
...
$qode_portfolio_disable_comments = new QodeMetaField(
	"selectblank",
	"qode_portfolio-hide-comments",
	"",
	esc_html__( "Disable Comments", 'brick' ),
	"",
	array(
		"no" => esc_html__( "No", 'brick' ),
		"yes" => esc_html__( "Yes", 'brick' )
...
$qode_portfolio_hover_color = new QodeMetaField(
	"color",
	"qode_portfolio-hover-color",
	"",
	esc_html__( "Portfolio Hover Color", 'brick' ),
	esc_html__( "Choose color for portfolio hover type", 'brick' )
);
$qodeGeneral->addChild(
	"qode_portfolio-hover-color",
...
$qode_subtitle_like_separator_margins = new QodeMetaField(
	"text",
	"qode_subtitle_like_separator_margins",
	"",
	esc_html__( "Margins for Subitle", 'brick' ),
...
$qode_subtitle_style = new QodeGroup(
	...
	esc_html__( "Define style for subtitle (When using separator around subtitle, only right margin is counted for left/right margin)", 'brick' )
);
$qode_page_title_area_container->addChild(
	"qode_subtitle_style",
	$qode_subtitle_style
