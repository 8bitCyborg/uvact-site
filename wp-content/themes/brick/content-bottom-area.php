...
} elseif ( brick_qode_options()->getOptionValue( 'enable_content_bottom_area' ) ) {
	$content_bottom_area = brick_qode_options()->getOptionValue( 'enable_content_bottom_area' );
}
...
} elseif ( brick_qode_options()->getOptionValue( 'content_bottom_sidebar_custom_display' ) ) {
	$content_bottom_area_sidebar = brick_qode_options()->getOptionValue( 'content_bottom_sidebar_custom_display' );
}
...
if ( $content_bottom_area == 'yes' && is_active_sidebar( $content_bottom_area_sidebar ) ) {
	...
	} elseif ( brick_qode_options()->getOptionValue( 'content_bottom_in_grid' ) ) {
		$content_bottom_area_in_grid = brick_qode_options()->getOptionValue( 'content_bottom_in_grid' );
	}
	...
	<div class="content_bottom" <?php brick_qode_inline_style( $content_bottom_background_color ); ?>>
