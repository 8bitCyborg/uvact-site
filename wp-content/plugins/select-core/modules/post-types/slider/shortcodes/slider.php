...
class Slider implements Lib\ShortcodeInterface {
    ...
    public function render($atts, $content = null) {
        ...
        if ($slider != "") {
            ...
            if ($slider_parallax == 'no' || ( brick_qode_options()->getOptionValue( 'paspartu' ) == 'yes' && (( brick_qode_options()->getOptionValue( 'paspartu_on_top' ) == 'yes') || ( brick_qode_options()->getOptionValue( 'paspartu_on_bottom_slider' ) == 'yes')))) {
            ...
            if (isset($slider_meta['slider_thumbs'])) {
                if( brick_qode_options()->getOptionValue( 'vertical_area' ) =='no' &&  brick_qode_options()->getOptionValue( 'paspartu' ) == 'no') {
            ...
            $anchor_data = '';
            if ($anchor != "") {
                $anchor_data .= 'data-q_id = "#' . esc_attr($anchor) . '"';
            }
            ...
            if ($height != "" && $responsive_height == "yes") {
                $responsiveness_data = 'data-q_responsive_breakpoints = "' . esc_attr($responsive_breakpoints) . '"';
            }
            ...
            if ( brick_qode_options()->getOptionValue( 'header_background_transparency_initial' ) != "1" && brick_qode_options()->getOptionValue( 'header_background_transparency_initial' ) != "") {
            ...
            if ( brick_qode_options()->getOptionValue( 'navigation_button_height' ) != '') {
                $arrow_button_height = esc_attr(brick_qode_options()->getOptionValue( 'navigation_button_height' ));
            }
            ...
            if ( brick_qode_options()->getOptionValue( 'enable_manu_item_border' ) == 'yes' &&  brick_qode_options()->getOptionValue( 'menu_item_style' ) == 'large_item') {
                if ( brick_qode_options()->getOptionValue( 'menu_item_border_style' ) == 'all_borders') {
                    $large_menu_item_border = esc_attr(brick_qode_options()->getOptionValue( 'menu_item_border_width' )) * 2;
                }
                if ( brick_qode_options()->getOptionValue( 'menu_item_border_style' ) == 'top_bottom_borders') {
                    $large_menu_item_border = esc_attr(brick_qode_options()->getOptionValue( 'menu_item_border_width' )) * 2;
                }
                if ( brick_qode_options()->getOptionValue( 'menu_item_border_style' ) == 'bottom_border') {
                    $large_menu_item_border = esc_attr(brick_qode_options()->getOptionValue( 'menu_item_border_width' ));
                }
            }
            ...
            if (brick_qode_options()->getOptionValue( 'header_bottom_appearance' )) {
                switch (brick_qode_options()->getOptionValue( 'header_bottom_appearance' )) {
                    case 'stick':
                        $logo_height = esc_attr(brick_qode_options()->getOptionValue( 'logo_height' )) / 2;
                        break;
                    ...
                    case 'fixed_hiding':
                        ...
                        break;
                    default:
                        $logo_height = esc_attr(brick_qode_options()->getOptionValue( 'logo_height' ));
                        break;
                }
            }
            ...
            if ((get_post_meta($page_id, "qode_header_color_transparency_per_page", true) !== "0") && (brick_qode_options()->getOptionValue( 'header_background_transparency_initial' ) !== "0") && (( brick_qode_options()->getOptionValue( 'paspartu' ) == 'no') || ( brick_qode_options()->getOptionValue( 'paspartu_on_top' ) == 'no')) && !$hide_sticky_header) {

                $header_height_padding = $header_height + $menu_bottom + $header_top;
                if (( brick_qode_options()->getOptionValue( 'center_logo_image' ) == "yes" && brick_qode_options()->getOptionValue( 'header_bottom_appearance' ) !== 'stick menu_bottom' && brick_qode_options()->getOptionValue( 'header_bottom_appearance' ) !== 'stick_with_left_right_menu') || brick_qode_options()->getOptionValue( 'header_bottom_appearance' ) == "fixed_hiding") {
            ...
            $custom_cursor = "";
            if( (brick_qode_options()->getOptionValue( 'qs_enable_navigation_custom_cursor' )=="yes")){
                $custom_cursor = "has_custom_cursor";
            }

            if(( brick_qode_options()->getOptionValue( 'paspartu' ) == 'yes' && (( brick_qode_options()->getOptionValue( 'paspartu_on_top' ) == 'yes') || ( brick_qode_options()->getOptionValue( 'paspartu_on_bottom_slider' ) == 'yes'))) || $slider_parallax == "no"){
            ...
            if(brick_qode_options()->getOptionValue( 'loading_animation' ) == "on") {
                if(brick_qode_options()->getOptionValue( 'loading_image' ) != "") {
                    $ajax_loader = '<div class="ajax_loader" ' . $loader_margin_top . '><div class="ajax_loader_1"><div class="ajax_loader_2"><img src="' . esc_url(brick_qode_options()->getOptionValue( 'loading_image' )) . '" alt="" /></div></div></div>';
                }else{
                    $ajax_loader = '<div class="ajax_loader" ' . $loader_margin_top . '><div class="ajax_loader_1">' . brick_qode_loading_spinners(true) . '</div></div>';
                }
            }

            $html .= '<div id="qode-' . esc_attr($slider) . '" ' . $anchor_data . ' ' . $responsiveness_data . ' ' . $responsive_coefficients_graphic_data . ' ' . $responsive_coefficients_title_data . ' ' . $responsive_coefficients_subtitle_data . ' ' . $responsive_coefficients_text_data . ' ' . $responsive_coefficients_button_data . ' class="carousel slide ' . esc_attr($animation_type_class . ' ' . $custom_cursor . ' ' . $full_screen_class . ' ' . $responsive_height_class . ' ' . $height_class . ' ' . $auto_start_class . ' ' . $header_effect_class . ' ' . $slider_numbers_class .  ' ' . $slider_thumbs_class . ' ' . $slider_transparency_class . ' ' . $navigation_position_class . ' ' . $content_next_to_arrows_class) . '" ' . $slide_animation . ' ' . $data_height . ' ' . $data_parallax_effect . ' '.brick_qode_get_inline_style($slide_holder_height. $background_color).'><div class="qode_slider_preloader" '.brick_qode_get_inline_style($background_color).'>'.$ajax_loader.'</div>';
            $html .= '<div class="carousel-inner ' . esc_attr($slider_css_position_class) . '" '.brick_qode_get_inline_style($carouselinner_height).' '.$data_parallax_transform.'>';
            ...
            if ($query_loop->have_posts()) : $postCount = 0;
                while ($query_loop->have_posts()) : $query_loop->the_post();
                    ...
                    $thumbnail_attributes = brick_qode_get_attachment_meta_from_url($thumbnail, array('width','height'));
                    ...
                    if ((get_post_meta(get_the_ID(), "qode_slide-title-font-family", true) !== "-1") && (get_post_meta(get_the_ID(), "qode_slide-title-font-family", true) !== "")) {
                        $slide_title_style .= "font-family: '" . esc_attr(str_replace('+', ' ', get_post_meta(get_the_ID(), "qode_slide-title-font-family", true))) . "';";
                    }
                    if (get_post_meta(get_the_ID(), "qode_slide-title-font-style", true) != "") {
                        $slide_title_style .= "font-style: " . esc_attr(get_post_meta(get_the_ID(), "qode_slide-title-font-style", true)) . ";";
                    }
                    if (get_post_meta(get_the_ID(), "qode_slide-title-font-weight", true) != "") {
                        $slide_title_style .= "font-weight: " . esc_attr(get_post_meta(get_the_ID(), "qode_slide-title-font-weight", true)) . ";";
                    }
                    ...
                    if (get_post_meta(get_the_ID(), 'qode_slide-title-text-transform', true) !== '') {
                        $slide_title_style .= 'text-transform: ' . esc_attr(get_post_meta(get_the_ID(), 'qode_slide-title-text-transform', true)) . ';';
                    }
                    ...
                    if (get_post_meta(get_the_ID(), 'qode_slide-title-background-color', true) !== '') {
                        ...
                        $slide_title_span_style .= 'background-color: ' . esc_attr(brick_qode_rgba_color($slide_title_bg_color, $slide_title_bg_transparency)) . ';';
                    }
                    ...
                    if (get_post_meta(get_the_ID(), "qode_slide-separator-title", true) == 'yes') {
                        ...
                        if ($slide_separator_type_var == "without_icon") {
                            ...
                            if ($slide_separator_color !== '') {
                                ...
                                if ($slide_separator_transparency !== '') {
                                    ...
                                    $slide_separator_rgba_color = brick_qode_rgba_color($slide_separator_color, $slide_separator_transparency);
                            ...
                            //is separator width set?
                            if (get_post_meta(get_the_ID(), 'qode_slide-separator-thickness', true) != '' && get_post_meta(get_the_ID(), 'qode_slide-title-separator-position', true) !== 'left_right') {
                            ...
                            if ($slide_separator_position != 'left_right') {
                                if (get_post_meta(get_the_ID(), "qode_slide-title-separator-align", true) != "") {
                                    $slide_separator_styles .= 'float:' . esc_attr(get_post_meta(get_the_ID(), "qode_slide-title-separator-align", true)) . ';';
                                }
                            }
                            ...
                            if (get_post_meta(get_the_ID(), 'qode_slide-separator-border-color', true) !== '') {
                                $slide_separator_border_color = esc_attr(get_post_meta(get_the_ID(), "qode_slide-separator-border-color", true));
                            }
                            $slide_separator_border_width = '';
                            if (get_post_meta(get_the_ID(), 'qode_slide-separator-border-width', true) !== '') {
                                $slide_separator_border_width = esc_attr(get_post_meta(get_the_ID(), "qode_slide-separator-border-width", true));
                            }
                            $slide_separator_border_style = '';
                            if (get_post_meta(get_the_ID(), 'qode_slide-separator-border-style', true) !== '') {
                                $slide_separator_border_style = esc_attr(get_post_meta(get_the_ID(), "qode_slide-separator-border-style", true));
                            }
                            ...
                            if (get_post_meta(get_the_ID(), "qode_slide-title-separator-position", true) == "left_right") {
                                ...
                                if (get_post_meta(get_the_ID(), 'qode_slide-separator-thickness', true) !== '') {
                                    $slide_separator_styles .= 'border-bottom-width:' . esc_attr(get_post_meta(get_the_ID(), "qode_slide-separator-thickness", true)) . 'px;';
                                }

                                if (get_post_meta(get_the_ID(), 'qode_slide_left_right_separator_style', true) !== '') {
                                    $slide_separator_styles .= 'border-bottom-style:' . esc_attr(get_post_meta(get_the_ID(), "qode_slide_left_right_separator_style", true)) . ';';
                                }

                                if (get_post_meta(get_the_ID(), 'qode_slide_left_separator_margin_right', true) !== '') {
                                    $slide_left_separator_margin .= 'margin-right:' . esc_attr(get_post_meta(get_the_ID(), "qode_slide_left_separator_margin_right", true)) . 'px;';
                                }
                                if (get_post_meta(get_the_ID(), 'qode_slide_right_separator_margin_left', true) !== '') {
                                    $slide_right_separator_margin .= 'margin-left:' . esc_attr(get_post_meta(get_the_ID(), "qode_slide_right_separator_margin_left", true)) . 'px;';
                                }

                                if (get_post_meta(get_the_ID(), 'qode_slide_left_right_separator_linedots', true) == 'yes') {

                                    if (get_post_meta(get_the_ID(), 'qode_slide_left_right_separator_line_dots_size', true) !== '') {
                                        $slide_dots_height = esc_attr(get_post_meta(get_the_ID(), 'qode_slide_left_right_separator_line_dots_size', true));
                                    ...
                                    if (get_post_meta(get_the_ID(), 'qode_slide_left_right_separator_dots_color', true) !== '') {
                                        $slide_dots_style .= 'background-color: ' . esc_attr(get_post_meta(get_the_ID(), 'qode_slide_left_right_separator_dots_color', true)) . ';';
                                    }
                                }
                        ...
                        if (get_post_meta(get_the_ID(), "qode_slide_title_separator_type", true) == "with_icon") {
                            ...
                            if (get_post_meta(get_the_ID(), "qode_slide_title_separator_with_icon_icon_pack", true) != ''){
                                ...
                                $slide_separator_icon_param = brick_qode_icon_collections()->getIconCollection($slide_separator_icon);
                        ...
                        if (get_post_meta(get_the_ID(), "qode_slide_title_separator_type", true) == "with_custom_icon") {

                            $slide_separator_position = "top";

                            if (get_post_meta(get_the_ID(), 'qode_slide_title_separator_with_custom_icon_position', true) != '') {
                                $slide_separator_position = esc_attr(get_post_meta(get_the_ID(), "qode_slide_title_separator_with_custom_icon_position", true));
                            }

                            $slide_separator_with_icon_params_array[] = "type='with_custom_icon'";

                            if (get_post_meta(get_the_ID(), "qode_slide_title_separator_with_custom_icon_custom_icon", true) !== ''){
                                $slide_separator_with_icon_params_array[] = "custom_icon='". esc_attr(get_post_meta(get_the_ID(), "qode_slide_title_separator_with_custom_icon_custom_icon", true))."'";
                            }

                            if (get_post_meta(get_the_ID(), "qode_slide_title_separator_with_custom_icon_line_style", true) !== ''){
                                $slide_separator_with_icon_params_array[] = "border_style='". esc_attr(get_post_meta(get_the_ID(), "qode_slide_title_separator_with_custom_icon_line_style", true))."'";
                            }

                            if (get_post_meta(get_the_ID(), "qode_slide_title_separator_with_custom_icon_separator_width", true) !== ''){
                                $slide_separator_with_icon_params_array[] = "width='". esc_attr(get_post_meta(get_the_ID(), "qode_slide_title_separator_with_custom_icon_separator_width", true))."'";
                            }

                            $slide_separator_with_custom_icon_margin_top = '40';
                            if (get_post_meta(get_the_ID(), "qode_slide_title_separator_with_custom_icon_separator_margin_top", true) !== ''){
                                $slide_separator_with_custom_icon_margin_top = esc_attr(get_post_meta(get_the_ID(), "qode_slide_title_separator_with_custom_icon_separator_margin_top", true));
                            }
                            ...
                            if (get_post_meta(get_the_ID(), "qode_slide_title_separator_with_custom_icon_separator_margin_bottom", true) !== ''){
                                $slide_separator_with_custom_icon_margin_bottom = esc_attr(get_post_meta(get_the_ID(), "qode_slide_title_separator_with_custom_icon_separator_margin_bottom", true));
                            }
                            $slide_separator_with_icon_params_array[] = "down='".$slide_separator_with_custom_icon_margin_bottom."'";

                            if (get_post_meta(get_the_ID(), "qode_slide_title_separator_with_custom_icon_separator_thickness", true) !== ''){
                                $slide_separator_with_icon_params_array[] = "thickness='". esc_attr(get_post_meta(get_the_ID(), "qode_slide_title_separator_with_custom_icon_separator_thickness", true))."'";
                            }

                            if (get_post_meta(get_the_ID(), "qode_slide_title_separator_with_custom_icon_separator_color", true) !== ''){
                                $slide_separator_with_icon_params_array[] = "color='". esc_attr(get_post_meta(get_the_ID(), "qode_slide_title_separator_with_custom_icon_separator_color", true))."'";
                            }

                            if (get_post_meta(get_the_ID(), 'qode_slide_title_separator_with_custom_icon_icon_margin', true) != '') {
                                $slide_separator_with_icon_params_array[] = "icon_margin='" . esc_attr(get_post_meta(get_the_ID(), "qode_slide_title_separator_with_custom_icon_icon_margin", true)) . "'";
                            }

                            if (get_post_meta(get_the_ID(), "qode_slide_title_separator_with_custom_icon_icon_postition", true) !== ''){
                                $slide_separator_with_icon_params_array[] = "separator_icon_position='". esc_attr(get_post_meta(get_the_ID(), "qode_slide_title_separator_with_custom_icon_icon_postition", true))."'";
                            }
                    ...
                    if ((get_post_meta(get_the_ID(), "qode_slide-subtitle-font-family", true) !== "-1") && (get_post_meta(get_the_ID(), "qode_slide-subtitle-font-family", true) !== "")) {
                        $slide_subtitle_style .= "font-family: '" . esc_attr(str_replace('+', ' ', get_post_meta(get_the_ID(), "qode_slide-subtitle-font-family", true))) . "';";
                    }
                    if (get_post_meta(get_the_ID(), "qode_slide-subtitle-font-style", true) != "") {
                        $slide_subtitle_style .= "font-style: " . esc_attr(get_post_meta(get_the_ID(), "qode_slide-subtitle-font-style", true)) . ";";
                    }
                    if (get_post_meta(get_the_ID(), "qode_slide-subtitle-font-weight", true) != "") {
                        $slide_subtitle_style .= "font-weight: " . esc_attr(get_post_meta(get_the_ID(), "qode_slide-subtitle-font-weight", true)) . ";";
                    }
                    ...
                    if (get_post_meta(get_the_ID(), 'qode_slide-subtitle-text-transform', true) !== '') {
                        $slide_subtitle_style .= 'text-transform: ' . esc_attr(get_post_meta(get_the_ID(), 'qode_slide-subtitle-text-transform', true)) . ';';
                    }
                    if (get_post_meta(get_the_ID(), 'qode_slide-hide-shadow', true) == 'yes') {
                    ...
                    if (get_post_meta(get_the_ID(), 'qode_slide-subtitle-background-color', true) !== '') {
                        ...
                        $slide_subtitle_span_style .= 'background-color: ' . esc_attr(brick_qode_rgba_color($slide_subtitle_bg_color, $slide_subtitle_bg_transparency)) . ';';
                    }
                    ...
                    if ($slide_text_separator_var == "no") {
                        ...
                        if ((get_post_meta(get_the_ID(), "qode_slide-text-font-family", true) !== "-1") && (get_post_meta(get_the_ID(), "qode_slide-text-font-family", true) !== "")) {
                            $slide_text_style .= "font-family: '" . esc_attr(str_replace('+', ' ', get_post_meta(get_the_ID(), "qode_slide-text-font-family", true))) . "';";
                        }
                        if (get_post_meta(get_the_ID(), "qode_slide-text-font-style", true) != "") {
                            $slide_text_style .= "font-style: " . esc_attr(get_post_meta(get_the_ID(), "qode_slide-text-font-style", true)) . ";";
                        }
                        if (get_post_meta(get_the_ID(), "qode_slide-text-font-weight", true) != "") {
                            $slide_text_style .= "font-weight: " . esc_attr(get_post_meta(get_the_ID(), "qode_slide-text-font-weight", true)) . ";";
                        }
                        ...
                        if (get_post_meta(get_the_ID(), 'qode_slide-text-text-transform', true) !== '') {
                            $slide_text_style .= 'text-transform: ' . esc_attr(get_post_meta(get_the_ID(), 'qode_slide-text-text-transform', true)) . ';';
                        }
                        if (get_post_meta(get_the_ID(), 'qode_slide-hide-shadow', true) == 'yes') {
                        ...
                        if (get_post_meta(get_the_ID(), 'qode_slide-text-background-color', true) !== '') {
                            ...
                            $slide_text_span_style .= 'background-color: ' . esc_attr(brick_qode_rgba_color($slide_text_bg_color, $slide_text_bg_transparency)) . ';';
                        }
                    ...
                    $content_predefined_position = get_post_meta(get_the_ID(), "qode_slide_predefined_content_position", true);
                    ...
                    if (get_post_meta(get_the_ID(), "qode_slide-content-full-width", true) == "yes" && get_post_meta(get_the_ID(), "qode_slide-content-vertical-middle", true) == "no") {
                        $content_full_width_class = "slide_full_width";
                    }else if(get_post_meta(get_the_ID(), "qode_slide_vertical_content_full_width", true) == "yes" && get_post_meta(get_the_ID(), "qode_slide-content-vertical-middle", true) == "yes"){
						$content_full_width_class = "slide_full_width";
					}
                    ...
                    if (get_post_meta(get_the_ID(), "qode_slide-content-vertical-middle", true) == "yes" && $content_predefined_position == "") {
                        ...
                        if($content_predefined_position != ""){
                            if(get_post_meta(get_the_ID(), "qode_slide_predefined_content_position_width", true) != ""){
                                $content_width = "width:" . esc_attr(get_post_meta(get_the_ID(), "qode_slide_predefined_content_position_width", true)) . "px;";
                            }else{
                    ...
                    if ($slide_type == 'video') {
                        ...
                        $html .= '<div class="video"><div class="mobile-video-image" '.brick_qode_get_inline_style('background-image: url(' . esc_url($video_image) . ')').'></div><div class="video-overlay';
                        ...
                        $html .= '<div class="image" '.brick_qode_get_inline_style('background-image:url(' . esc_url($image) . ')').'>';
                        if ($slider_thumbs == 'no') {
                            $html .= '<img src="' . esc_url($image) . '" alt="' . esc_attr($title) . '">';
                        }

                        if ($image_overlay_pattern !== "") {
                            $html .= '<div class="image_pattern" '.brick_qode_get_inline_style('background: url(' . esc_url($image_overlay_pattern) . ') repeat 0 0').'></div>';
                        }
                        $html .= '</div>';
                    }
                    ...
                    if (get_post_meta(get_the_ID(), "qode_slide-subtitle", true) != "") {
                        ...
                        $html_text .= '<h3 class="q_slide_subtitle" '.brick_qode_get_inline_style($slide_subtitle_style).'><span '.brick_qode_get_inline_style($slide_subtitle_span_style).'>' . wp_kses_post(get_post_meta(get_the_ID(), 'qode_slide-subtitle', true)) . '</span></h3>';
                        $html_text .= '</div></div>';
                    }

                    if ((get_post_meta(get_the_ID(), "qode_slide-separator-title", true) == 'yes') && ($slide_separator_position != 'bottom' ) && ($slide_separator_position) != 'left_right') {
                        //append separator html
                        if (get_post_meta(get_the_ID(), 'qode_slide_title_separator_type', true) !== 'with_icon' && get_post_meta(get_the_ID(), 'qode_slide_title_separator_type', true) !== 'with_custom_icon') {
                            $html_text .= '<div class="el">';
                            $html_text .= '<div '.$slide_separator_top_data.'>';
                            $html_text .= '<div '.brick_qode_get_inline_style($slide_separator_styles.$slide_top_separator_styles).' class="separator separator_top"></div>';
                            $html_text .= '</div></div>';
                        }
                        else {
                            $html_text .= '<div class="el">';
                    ...
                    if (get_post_meta(get_the_ID(), "qode_slide-hide-title", true) != true) {
                        ...
                        $html_text .= '<h2 class="q_slide_title" '.brick_qode_get_inline_style($slide_title_style).'>';
                        if ($slide_separator_position == 'left_right') {
                            $html_text .= '<div '.brick_qode_get_inline_style($slide_separator_styles.$slide_left_separator_margin).' class="separator separator_left"><span class="slide_separator_dots" '.brick_qode_get_inline_style($slide_dots_style).'></span></div>';
                        }
                        if (get_post_meta(get_the_ID(), "qode_slide-title-link", true) != '') {
                            $html_text .= '<a '.brick_qode_get_inline_style($slide_title_style).' '.$slide_title_data.' href="' . esc_url(get_post_meta(get_the_ID(), "qode_slide-title-link", true)) . '" target="' . esc_attr(get_post_meta(get_the_ID(), "qode_slide-title-target", true)) . '">';
                        }
                        $html_text .= '<span '.brick_qode_get_inline_style($slide_title_span_style).'>' . wp_kses_post(get_the_title()) . '</span>';
                        if (get_post_meta(get_the_ID(), "qode_slide-title-link", true) != '') {
                            $html_text .= '</a>';
                        }
                        if ($slide_separator_position == 'left_right') {
                            $html_text .= '<div '.brick_qode_get_inline_style($slide_separator_styles.$slide_right_separator_margin).' class="separator separator_right"><span class="slide_separator_dots" '.brick_qode_get_inline_style($slide_dots_style).'></span></div>';
                        }
                        $html_text .= '</h2></div></div>';
                    }

                    if ((get_post_meta(get_the_ID(), "qode_slide-separator-title", true) == 'yes') && ($slide_separator_position != 'top') && ($slide_separator_position) != 'left_right') {
                        //append separator html
                        if (get_post_meta(get_the_ID(), 'qode_slide_title_separator_type', true) !== 'with_icon' && get_post_meta(get_the_ID(), 'qode_slide_title_separator_type', true) !== 'with_custom_icon') {
                            $html_text .= '<div class="el">';
                            $html_text .= '<div ' . $slide_separator_bottom_data . '>';
                            $html_text .= '<div '.brick_qode_get_inline_style($slide_separator_styles.$slide_bottom_separator_styles).'  class="separator separator_bottom"></div>';
                            $html_text .= '</div></div>';
                        }
                        else {
                            $html_text .= '<div class="el">';
                    ...
                    if (get_post_meta(get_the_ID(), "qode_slide-text", true) != "") {
                        ...
                        if ($slide_text_separator_var == 'yes') {
                            ...
                            $html_text .= '<h3 class="q_slide_text" '.brick_qode_get_inline_style($slide_text_style).'><span '.brick_qode_get_inline_style($slide_text_span_style).'>' . wp_kses_post(get_post_meta(get_the_ID(), "qode_slide-text", true)) . '</span></h3>';
                        }
                        $html_text .= '</div></div>';
                    }

                    //check if first button should be displayed
                    $is_first_button_shown = (get_post_meta(get_the_ID(), "qode_slide-button-label", true) != "" || get_post_meta(get_the_ID(), "button1_icon_pack", true))
                        && get_post_meta(get_the_ID(), "qode_slide-button-link", true) != "";

                    //check if second button should be displayed
                    $is_second_button_shown = (get_post_meta(get_the_ID(), "qode_slide-button-label2", true) != "" || get_post_meta(get_the_ID(), "button2_icon_pack", true))
                        && get_post_meta(get_the_ID(), "qode_slide-button-link2", true) != "";
					...
					if (get_post_meta(get_the_ID(), "qode_slide_button1_width", true) != "") {
                        $button_text_style1 .= "width:" . esc_attr(get_post_meta(get_the_ID(), "qode_slide_button1_width", true)) . "px;";
                    }
                    ...
                    if ($is_first_button_shown) {
                        ...
                        if(get_post_meta(get_the_ID(), "qode_slide-button-label", true) !== '') {
                            $first_button_icon_class .= ' icon_right';
                        }
						
						if(get_post_meta(get_the_ID(), "qode_slide_button1_hover_animation", true) == 'move_icon') {
                            $first_button_class .= ' move_icon';
                        }

                        if(get_post_meta(get_the_ID(), 'button1_icon_pack', true) !== 'no_icon') {
                            $first_btn_icon_collection = brick_qode_icon_collections()->getIconCollection(get_post_meta(get_the_ID(), 'button1_icon_pack', true));
                        ...
                        $html_text .= '<a class="qbutton '.esc_attr($first_button_class).''.esc_attr($first_button_icon_class).'" ' . $data_attr1 . ' '.brick_qode_get_inline_style($button_text_style1).' '.$slide_button_1_data.' href="' . esc_url(get_post_meta(get_the_ID(), "qode_slide-button-link", true)) . '" target="' . esc_attr($slide_button_target) . '">' . esc_html(get_post_meta(get_the_ID(), "qode_slide-button-label", true)) .$first_button_icon_html. '</a>';
                    }
					...
					if (get_post_meta(get_the_ID(), "qode_slide_button2_width", true) != "") {
                        $button_text_style2 .= "width:" . esc_attr(get_post_meta(get_the_ID(), "qode_slide_button2_width", true)) . "px;";
                    }
                    ...
                    if ($is_second_button_shown) {
                        ...
                        if(get_post_meta(get_the_ID(), 'button2_icon_pack', true) !== 'no_icon') {
                            $second_btn_icon_collection = brick_qode_icon_collections()->getIconCollection(get_post_meta(get_the_ID(), 'button2_icon_pack', true));
                            ...
                            if(is_object($second_btn_icon_collection) && method_exists($second_btn_icon_collection, 'render')
                                ...
                                if(get_post_meta(get_the_ID(), "qode_slide-button-label2", true) !== '') {
                                    $second_button_icon_class .= ' icon_right';
                                }
                            }
                        }

                        $html_text .= '<a class="qbutton '.esc_attr($second_button_icon_class).'" ' . $data_attr2 . ' '.brick_qode_get_inline_style($button_text_style2).' '.$slide_button_2_data.' href="' . esc_url(get_post_meta(get_the_ID(), "qode_slide-button-link2", true)) . '" target="' . esc_attr($slide_button_target2) . '">' . esc_html(get_post_meta(get_the_ID(), "qode_slide-button-label2", true)) .$second_button_icon_html. '</a>';
                    }
                    ...
                    if (get_post_meta(get_the_ID(), "qode_slide-anchor-button", true) !== '') {
                        ...
                        $html_text .= '<div class="slide_anchor_holder el"><a ' . $slide_anchor_style . ' class="slide_anchor_button anchor" href="' . esc_url(get_post_meta(get_the_ID(), "qode_slide-anchor-button", true)) . '"><i class="fa fa-angle-down"></i></a></div>';
                    }
                    ...
                    if ($separate_text_graphic != 'yes') {
                        $html .= '<div class="slider_content ' . esc_attr($content_alignment) .'" '.brick_qode_get_inline_style($content_width . $content_xaxis . $content_yaxis_start).' '.$slide_data_start.' '.$slide_data_end.'>';
                        if(get_post_meta(get_the_ID(), "qode_slide-content-vertical-middle", true) == "yes"){
							$html .= '<div class="slider_content_inner" '.brick_qode_get_inline_style($vertical_content_width . $vertical_content_xaxis).'>';
						}
						$html .= $html_thumb;
						$html .= $html_text;
						if(get_post_meta(get_the_ID(), "qode_slide-content-vertical-middle", true) == "yes"){
                        ...
                        $html .= '<div class="slider_content graphic_content ' . esc_attr($graphic_alignment) . '" '.brick_qode_get_inline_style($graphic_width . $graphic_xaxis . $graphic_yaxis_start).'>';
							if(get_post_meta(get_the_ID(), "qode_slide-content-vertical-middle", true) == "yes"){
								$html .= '<div class="slider_content_inner" '.brick_qode_get_inline_style($vertical_content_width . $vertical_content_xaxis).'>';
							}
							$html .= $html_thumb;
            ...
            if ($found_slides > 1) {
                if ($show_navigation_circles == "yes") {
                    ...
                    $triangle_bkg='';
                    if( brick_qode_options()->getOptionValue( 'enable_slider_triangle' ) == 'yes') {
                    ...
                    if ($query_loop->have_posts()) : $postCount = 0;
                        while ($query_loop->have_posts()) : $query_loop->the_post();
                            ...
                            $html .= '<li data-target="#qode-' . esc_attr($slider) . '" data-slide-to="' . esc_attr($postCount) . '"';
                            if ($postCount == 0) {
                                $html .= ' class="active"';
                            }
                            $html .= '></li>';
                ...
                if ($show_navigation_arrows == "yes") {
                    ...
                    if ( brick_qode_options()->getOptionValue( 'navigation_arrows_type' ) != '') {
                        $icon_navigation_class = brick_qode_options()->getOptionValue( 'navigation_arrows_type' );
                    }
                    $direction_nav_classes = brick_qode_horizontal_slider_icon_classes($icon_navigation_class);

                    $html .= '<div class="controls_holder">';
                    $html .= '<a class="left carousel-control" href="#qode-' . esc_attr($slider) . '" data-slide="prev" data-start="opacity: 1;" data-300="opacity:0;">';
                    if ($slider_thumbs == 'yes') {
                    ...
                    $html .= '</a>';
                    $html .= '<a class="right carousel-control" href="#qode-' . esc_attr($slider) . '" data-slide="next" data-start="opacity: 1;" data-300="opacity:0;">';
                    if ($slider_thumbs == 'yes') {
