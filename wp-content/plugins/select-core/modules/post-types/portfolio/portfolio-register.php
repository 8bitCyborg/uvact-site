...
class PortfolioRegister implements PostTypeInterface {
    ...
    public function registerSingleTemplate($single) {
        ...
        if($post->post_type == $this->base) {
            if(!file_exists(get_template_directory().'/single-portfolio_page.php')) {
                return BRICK_CORE_CPT_PATH.'/portfolio/templates/single-'.$this->base.'.php';
            }
        }
    ...
    private function registerPostType() {
	    ...
	    $menuPosition = brick_qode_framework()->getSkin()->getMenuItemPosition('portfolio');
	    $menuIcon = brick_qode_framework()->getSkin()->getMenuIcon('portfolio');
	
	    if ( brick_qode_options()->getOptionValue( 'portfolio_single_slug' ) ) {
		    $slug = brick_qode_options()->getOptionValue( 'portfolio_single_slug' );
	    }
