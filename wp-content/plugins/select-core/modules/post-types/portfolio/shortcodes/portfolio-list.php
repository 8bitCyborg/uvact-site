...
class PortfolioList implements Lib\ShortcodeInterface {
    ...
    public function render($atts, $content = null) {
        ...
        if (brick_qode_options()->getOptionValue( 'portfolio_qode_like' )) {
            $portfolio_qode_like = brick_qode_options()->getOptionValue( 'portfolio_qode_like' );
        }

        $portfolio_filter_class = "";
	    if (brick_qode_options()->getOptionValue( 'portfolio_filter_disable_separator' ) == "yes") {
        ...
        if ( brick_qode_options()->getOptionValue( 'paspartu_portfolio_full_width' ) =='yes' ){
        ...
        if ( $padding_between !== '' && ($type == "masonry_with_space" || $type == "masonry_with_space_without_description")) {
            ...
            elseif($type == "masonry_with_space_without_description"){
                $article_style[] = "padding:".$padding_between."px;";
            }
            $project_holder_style .= "margin:0 -".$padding_between."px;";
        }
        ...
        if ($overlay_background_color != '' || $gradient_position != '') {
            if ($hover_type == "gradient_hover") {
                if (substr($overlay_background_color, 0, 3) === "rgba") { // if rgba is set, portfolio uses default color
                    ...
                    $rgb = brick_qode_hex2rgb($overlay_background_color);
        ...
        if ($box_border == "yes" || $box_background_color != "" &&($type == 'standard' || $type == 'standard_no_space' || $type == 'masonry_with_space')) {
        ...
        if ($type != 'masonry') {
            ...
            $html .= "<div class='portfolio_main_holder projects_holder $portfolio_loading_class clearfix v$columns$_type_class' style='".$project_holder_style."'>\n";
            if ($type == 'masonry_with_space' || $type == "masonry_with_space_without_description") {
            ...
            if ($query_loop->have_posts()) : while ($query_loop->have_posts()) : $query_loop->the_post();
                    ...
                    if ($overlay_background_color != '' || $gradient_position != '') {
                        if ($hover_type == "gradient_hover") {
                            if (substr($overlay_background_color_custom, 0, 3) === "rgba") { // if rgba is set, portfolio uses default color
                                ...
                                $rgb = brick_qode_hex2rgb($overlay_background_color_custom);
                    ...
                    case 'circle_hover': {
                        if ($disable_text_holder != 'yes' || $show_icons == 'yes' || $hover_type == 'thin_plus_only') {
                            ...
                            elseif ($type == 'text_on_hover_image' || $type == 'text_on_hover_image_no_space' || $type == 'text_before_hover' || $type == 'text_before_hover_no_space' || $type == 'masonry_with_space_without_description') {
                                if ($show_title == 'yes') {
                                    if ($disable_link_on_title != "yes") {
                                        $html .= '<' . $title_tag . ' class="portfolio_title" ' . $title_style . '><a href="' . esc_url( $portfolio_link ) . '" ' . $title_link_style . '>' . get_the_title() . '</a></' . $title_tag . '>';
                                    } else {
                            ...
                            if ($show_icons == 'yes') {
                                ...
                                if ($lightbox == "yes") {
                                    $html .= '<a class="portfolio_lightbox" title="' . $title . '" href="' . esc_url( $large_image ) . '" data-rel="prettyPhoto[' . $slug_list_ . ']" rel="prettyPhoto[' . $slug_list_ . ']"></a>';
                                }
                                if ($portfolio_qode_like == "on" && $show_like == "yes") {
                                    $html .= brick_qode_like_portfolio_list(get_the_ID());
                                }
                                if ($link_icon == "yes") {
                                    $html .= '<a class="preview" title="' . esc_attr__( 'Go to Project', 'select-core' ) . '"  href="' . esc_url( $portfolio_link ) . '" data-type="portfolio_list" target="' . $target . '" ></a>';
                                }
                ...
                if ($disable_link != "yes") {
                    if ($portfolio_link_pointer == 'single') {
                        ...
                        $html .= '<a class="portfolio_link_class" title="' . $title . '" href="' . esc_url( $large_image ) . '" data-rel="prettyPhoto[' . $slug_list_ . ']" rel="prettyPhoto[' . $slug_list_ . ']"></a>';
                    }
                }
                ...
                if ($type == "standard" || $type == "standard_no_space" || $type == "masonry_with_space") {
                    $html .= "<div class='portfolio_description " . $portfolio_description_class . "' ".brick_qode_get_inline_style(implode('; ', $portfolio_box_style)).">";

                    if ($show_title == 'yes') {
                        if ($disable_link_on_title != "yes") {
                            $html .= '<' . $title_tag . ' class="portfolio_title" ' . $title_style . '><a href="' . esc_url( $portfolio_link ) . '" target="' . $target . '" ' . $title_link_style . '>' . get_the_title() . '</a></' . $title_tag . '>';
                            if ($separator == 'yes') {
                                $html .= '<span class="separator ' . $separator_animation_class . '" ' . $separator_style . '></span>';
                            }
                        } else {
            ...
            if (get_next_posts_link()) {
                if ($show_load_more == "yes" || $show_load_more == "") {
                    $html .= '<div class="portfolio_paging" ' . $show_more_style . '><span data-rel="' . $query_loop->max_num_pages . '" class="load_more">' . get_next_posts_link(esc_html__('Show more', 'select-core')) . '</span></div>';
                    $html .= '<div class="portfolio_paging_loading"><a href="javascript: void(0)" class="qbutton">' . esc_html__('Loading...', 'select-core') . '</a></div>';
                }
            }
                ...
                switch ($hover_type) {
                    ...
                    case 'split_up': {
                        ...
                        if ($show_icons == "yes") {
                            ...
                            if ($link_icon == "yes") {
                                $html .= '<a class="preview" title="' . esc_attr__( 'Preview', 'select-core' ) . '"  href="' . esc_url( $portfolio_link ) . '" data-type="portfolio_list" target="' . $target . '" ></a>';
                            }
                            $html .= '</div>';  // icons_holder
                        }
                    }
