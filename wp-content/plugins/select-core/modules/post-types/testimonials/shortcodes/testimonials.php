...
class Testimonials implements Lib\ShortcodeInterface {
            ...
            vc_map( array(
                ...
                "params" => array(
                    ...
                    array(
                        ...
                        "holder" => "div",
                        "class" => "",
                        "heading" => "Navigation Arrows Animation",
    ...
    public function render($atts, $content = null) {
        ...
        if ($show_navigation_arrows == "yes") {
            ...
            if ($arrows_animation == "zoom") {
            	$testimonials_clasess .= ' arrows_animate_zoom';
            }
        }
        ...
        if ( $show_image_border == "yes" ) {
         ...
         if ($text_font_size != "" || $text_color != "" || $text_top_padding != "" || $text_bottom_padding != "") {
